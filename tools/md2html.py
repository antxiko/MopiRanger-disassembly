...
PIE = {
    "es": "<em>Mopi Ranger</em> lo publico Konami para MSX en 1985; su numero de catalogo es RC-728 y son 16 KB. Todos los derechos sobre el juego siguen siendo de sus titulares. Este trabajo es de preservacion, estudio y documentacion, y la imagen del cartucho no se distribuye.",
    "en": "<em>Mopi Ranger</em> was published by Konami for the MSX in 1985; its catalogue number is RC-728 and it is 16 KB. All rights in the game remain with their holders. This is preservation, study and documentation work, and the cartridge image is not distributed.",
}
...
def main(docdir, idioma="en"):
    ...
    for fn in sorted(os.listdir(docdir)):
        ...
        titulo = (m.group(1) if m else fn[:-3]) + " — Mopi Ranger (Konami, 1985)"
