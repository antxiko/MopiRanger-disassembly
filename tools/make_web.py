#!/usr/bin/env python3
"""Genera la portada de la web de Mopi Ranger, en los dos idiomas.
...
TXT = {
    "es": dict(
        titulo="Mopi Ranger - desensamblado comentado",
        ...
        claim="El premio secreto de la casa -5730 puntos, que en japones "
              "se leen <i>go-na-mi</i>-, una demostracion que no es "
              "inteligencia sino una partida grabada de 77 pulsaciones, y un "
              "juego que no guarda mapa de colisiones: lee la pantalla para "
              "saber por donde se puede pasar.",
        ficha=["Konami - <b>(c) Konami 1985</b>",
               "Cartucho <b>RC-728</b>, 16 KB",
               "MSX1 - <b>pagina 1</b>", "Volcado <b>89ae5bdd...</b>"],
    ...
    "en": dict(
        titulo="Mopi Ranger - a commented disassembly",
        ...
        claim="The house's secret bonus -5730 points, which read "
              "<i>go-na-mi</i> in Japanese-, an attract mode that is not AI "
              "but a recorded game of 77 keypresses, and a game that keeps no "
              "collision map at all: it reads the screen to find out where "
              "you can walk.",
        ficha=["Konami - <b>(c) Konami 1985</b>",
               "An <b>RC-728</b> 16 KB cartridge",
               "MSX1 - <b>page 1</b>", "Dump <b>89ae5bdd...</b>"],
